...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-6 py-3 lg:py-6.5">
        ...
        <nav className="mt-2 py-4 px-4 lg:mt-3 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Anak Panti --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/anak-asuh" || pathname.includes("anak-asuh")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/dashboard/kesehatan-anak"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/dashboard/kesehatan-anak" &&
                                "text-white"
                              }`}
                            >
                              Kesehatan Anak
              ...
              <li>
                <Link
                  href="/dashboard/pengurus-panti"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("pengurus-panti") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
              ...
              {/* <!-- Menu Item Program Panti  --> */}
              <li>
                <Link
                  href="/program-panti"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("program-panti") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
